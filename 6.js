...
class RegularDiscountPlan extends Basket {
  ...
  applyDiscount(price) {
    return price * 0.9;   // Повертає ціну з урахуванням знижки в 10% price * 0.9
  }
}
...
class VIPDiscountPlan extends Basket {
  // Робимо метод applyDiscount, що приймає ціну price як параметр
  applyDiscount(price) {
    return price * 0.8; // Повертає ціну з урахуванням знижки в 20% price * 0.8
  }
}
...
class NewClientDiscountPlan extends Basket {
  // Робимо метод applyDiscount, що приймає ціну price як параметр
  applyDiscount(price) {
    return price * 0.95; // Повертає ціну з урахуванням знижки в 5% price * 0.95
  }
}
